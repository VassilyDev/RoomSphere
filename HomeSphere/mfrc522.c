...
uint8_t mfrc522_init(void)
{
	...
	Log_Debug("[SPI] Opened SPI Interface\n");
	if (spiFd < 0) {
	...
	Log_Debug("[SPI] BitOrder = SPI_BitOrder_MsbFirst\n");
	if (result != 0) {
